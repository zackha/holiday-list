...
export default function TypeFilter({ filters, filterOptions, handleChange }: TypeFilterProps) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <MenuButton className="inline-flex justify-center gap-x-1.5 rounded-lg bg-white px-3.5 h-9 items-center text-neutral-700 shadow-sm ring-1 ring-inset ring-neutral-200 hover:bg-indigo-50 hover:text-black whitespace-nowrap transition-all capitalize">
        {selectedType}
      ...
      <Transition
        ...
        <MenuItems className="absolute left-0 z-10 mt-2 w-40 origin-top-left rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="p-2">
            <MenuItem
              as="button"
              onClick={() => handleChange('type', '')}
