...
export function GithubButton(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <mask id="GithubButton0" width="24" height="24" x="0" y="0">
        <g fill="#fff">
      ...
      <rect width="8" height="4" x="8" y="11" fill="currentColor" mask="url(#GithubButton0)">
